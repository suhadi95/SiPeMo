...
<div class="py-3 sm:py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Info Card -->
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg ring-1 ring-green-100 mb-4 sm:mb-6">
                ...
                <div class="flex items-start sm:items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-1 sm:mt-2 text-xs sm:text-sm text-green-700">
                            <p class="hidden sm:block">Pantau perkembangan penyusunan modul dari seluruh jurusan. Ringkasan status progres, final draft, dan publikasi modul.</p>
