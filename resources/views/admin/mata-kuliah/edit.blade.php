                ...
                <form action="{{ route('admin.mata-kuliah.update', $mataKuliah) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_mata_kuliah" id="kode_mata_kuliah" value="{{ old('kode_mata_kuliah', $mataKuliah->kode_mata_kuliah) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_mata_kuliah" id="nama_mata_kuliah" value="{{ old('nama_mata_kuliah', $mataKuliah->nama_mata_kuliah) }}" 
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3" 
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $mataKuliah->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
