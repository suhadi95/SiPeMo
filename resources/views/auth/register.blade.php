<x-guest-with-header-footer>
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Daftar Akun SiPeMo</h1>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-600 mt-1">Isi data diri Anda untuk membuat akun</p>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input id="name" class="w-full pl-10" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input id="email" class="w-full pl-10" type="email" name="email" :value="old('email')" required autocomplete="username" />
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input id="password" class="w-full pl-10" type="password" name="password" required autocomplete="new-password" />
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input id="password_confirmation" class="w-full pl-10" type="password" name="password_confirmation" required autocomplete="new-password" />
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                </svg>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="text-green-600 hover:text-green-700 font-medium underline">
                            Masuk di sini
                        </a>
                    </p>
                </div>
