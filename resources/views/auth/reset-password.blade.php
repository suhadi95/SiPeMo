    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-8 py-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-600 mt-1">Buat password yang kuat dan mudah diingat</p>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <x-text-input id="email" class="w-full pl-10" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
                    ...
                    <!-- Password -->
                    <div class="space-y-2">
                        <x-input-label for="password" :value="__('Password Baru')" class="text-sm font-medium text-gray-700" />
                        <div class="relative">
